...
const Resume: React.FC = () => {
  return (
    <main className="flex flex-col items-center justify-center text-black px-4 md:px-8">
      {/* Main content */}
      <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mt-8 mb-4">Owais Abbasi</h1>
